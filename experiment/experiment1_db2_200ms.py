...
def exp1_run_forone(sub):
    ...
    if not os.path.exists(f'../save_folder_exp1/db2_200ms'):
        os.makedirs(f'../save_folder_exp1/db2_200ms')
    ...
    save_path_1 = f'../save_folder_exp1/db2_200ms/tc_encoder_{sub}.pt'
    ...
    save_path_2 = f'../save_folder_exp1/db2_200ms/model_{sub}.pt'
    metric = Accuracy2()
    ...
    save_path_3 = f'../save_folder_exp1/db2_200ms/model_finetune1_{sub}.pt'
    ...
    save_path_4 = f'../save_folder_exp1/db2_200ms/model_finetune2_{sub}.pt'
    ...
    # save_path_5 = f'../save_folder_exp1/db2_200ms/model_finetune3_{sub}.pt'
    #
    ...
    #
    # # Record the results.
    # file = open("../save_folder_exp1/db2_200ms/best_score.txt", "a")
