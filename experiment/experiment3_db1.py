...
def exp1_run_forone(sub, t):
    ...
    if not os.path.exists(f'../save_folder_exp3/db1_{temper_str}'):
        os.makedirs(f'../save_folder_exp3/db1_{temper_str}')
    ...
    save_path_1 = f'../save_folder_exp3/db1_{temper_str}/tc_encoder_{sub}.pt'
    ...
    save_path_2 = f'../save_folder_exp3/db1_{temper_str}/model_{sub}.pt'
    metric = Accuracy2()
    ...
    # save_path_3 = f'../save_folder_exp3/db1_{temper_str}/model_finetune1_{sub}.pt'
    ...
    #
    # save_path_4 = f'../save_folder_exp3/db1_{temper_str}/model_finetune2_{sub}.pt'
    #
    ...
    # save_path_5 = f'../save_folder_exp3/db1_{temper_str}/model_finetune3_{sub}.pt'
    #
    ...
    # Record the results.
    file_path = f"../save_folder_exp3/db1_best_score.txt"
