...
def exp4_run_forone(sub):
    ...
    # The pre-training
    encoder = AlexNet_exp4(seq_lens * channels).to('cuda')
    linear_project = Linear_Project().to('cuda')
    model_pretrain = Model_pretrain(encoder, linear_project)
    save_path_1 = f'../save_folder_exp4/db1/Alexnet_encoder_{sub}.pt'
    ...
    save_path_2 = f'../save_folder_exp4/db1/model_Alexnet_encoder_{sub}.pt'
    metric = Accuracy2()
    ...
    save_path_3 = f'../save_folder_exp4/db1/model_Alexnet_encoder_finetune1_{sub}.pt'
    metric_finetune = Accuracy2()
    loss_finetune = nn.CrossEntropyLoss()
    opt_finetune1 = optim.Adam(model_finetune1.parameters(), lr=0.001)
    ...
    runner_finetune1.train(train_loader=trainloader_2, dev_loader=devloader_2, num_epochs=6, log_stride=128)
    ...
    save_path_4 = f'../save_folder_exp4/db1/model_Alexnet_encoder_finetune2_{sub}.pt'
    ...
    save_path_5 = f'../save_folder_exp4/db1/model_Alexnet_encoder_finetune3_{sub}.pt'
    ...
    # Record the results.
    file = open("../save_folder_exp4/db1/best_score_Alexnet_encoder.txt", "a")
