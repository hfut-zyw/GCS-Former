...
def exp1_run_forone(sub, seq_len):
    ...
    if not os.path.exists(f'../save_folder_exp2/db1_{seq_len}ms'):
        os.makedirs(f'../save_folder_exp2/db1_{seq_len}ms')
    ...
    save_path_1 = f'../save_folder_exp2/db1_{seq_len}ms/tc_encoder_{sub}.pt'
    ...
    save_path_2 = f'../save_folder_exp2/db1_{seq_len}ms/model_{sub}.pt'
    metric = Accuracy2()
    ...
    save_path_3 = f'../save_folder_exp2/db1_{seq_len}ms/model_finetune1_{sub}.pt'
    ...
    save_path_4 = f'../save_folder_exp2/db1_{seq_len}ms/model_finetune2_{sub}.pt'
    ...
    save_path_5 = f'../save_folder_exp2/db1_{seq_len}ms/model_finetune3_{sub}.pt'
    ...
    # Record the results.
    file_path = f"../save_folder_exp2/db1_best_score.txt"
