...
def exp1_run_forone(sub):
    ...
    if not os.path.exists(f'../save_folder_exp1/db2_150ms'):
        os.makedirs(f'../save_folder_exp1/db2_150ms')
    ...
    save_path_1 = f'../save_folder_exp1/db2_150ms/tc_encoder_{sub}.pt'
    ...
    save_path_2 = f'../save_folder_exp1/db2_150ms/model_{sub}.pt'
    metric = Accuracy2()
    ...
    save_path_3 = f'../save_folder_exp1/db2_150ms/model_finetune1_{sub}.pt'
    ...
    save_path_4 = f'../save_folder_exp1/db2_150ms/model_finetune2_{sub}.pt'
    ...
    # The 3rd round of fine-tuning,lr=0.000002
    # try:
    ...
    # save_path_5 = f'../save_folder_exp1/db2_150ms/model_finetune3_{sub}.pt'
    #
    # opt_finetune3 = optim.SGD(model_finetune3.parameters(), lr=0.000002)
    ...
    # runner_finetune3.train(train_loader=trainloader_2, dev_loader=devloader_2, num_epochs=8, log_stride=128)
    # best_score_log.append(runner_finetune3.best_score)
    #
    # Record the results.
    file = open("../save_folder_exp1/db2_150ms/best_score.txt", "a")
